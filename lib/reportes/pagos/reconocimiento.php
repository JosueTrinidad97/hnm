...
class Reportes
{
	...
	public function generarFichaPago()
	{
		...
		$datos = PonenteModelo::obtnerDatosPonenteReconocimiento($this->idponente);
	...
	<table>
		...
		<h1 style = "font-size:24px: font-style:bold;">RECONOCIMIENTO</h1>
		<p style = "font-size:14px">$documento[sujeto]</p>
		<h2 style = "font-size:15px: font-style:bold;">$datos[nombre]</h2>
		<p style = "font-size:14px">$documento[descripcion]</p>
		<h3 style = "font-size:15px: font-style:bold;">$datos[tema]</h3>
...
if(isset($_GET['idPonente'])){
    ...
    $reporte -> idponente = $_GET['idPonente'];
