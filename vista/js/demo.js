...
$(".btnInscripcionEvento").on('click', function () {

  var idEvento = $(this).attr('idEvento')


  $("#tema").val($(this).attr('nombreEvento'))
...
$(".selectInscripcionEvento").on('change', function () {
...
$(".selectedTipoAsistente").on("change", function () {
  var idCosto = $(this).val();

  // alert(idCosto);


  $(".total").val(costos[idCosto]);
})
