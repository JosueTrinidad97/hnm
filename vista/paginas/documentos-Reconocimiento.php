...
<div class="row">
    <div class="col-md-8 col-12">
        <iframe src="http://localhost/HNM%20avance5/lib/reportes/pagos/reconocimiento_conf.php" width="100%" height="700" frameborder="0"></iframe>

    </div>
    <?php

    $documento = DocumentoModelo::mdlObtnerTipoDocumento('RECONOCIMIENTO');
    //var_dump($documento);
    ?>
    <div class="col-md-4 col-12">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="hidden" value="RECONOCIMIENTO" name="tipo">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary float-right" name='btnActualizarDocumento'>Guardar</button>

            </div>
            <?php $editarDocumento = new DocumentoControlador();
            $editarDocumento->ctrEditarDocumento2();
            ?>
        </form>
    </div>
</div>